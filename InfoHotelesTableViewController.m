//
//  InfoHotelesTableViewController.m
//  1sillaparamibolso
//
...
@interface InfoHotelesTableViewController ()

@end

@implementation InfoHotelesTableViewController
...
@synthesize recipeLabel,recipeLabel2,recipeLabel3,recipeLabel4,pageControl,table;
