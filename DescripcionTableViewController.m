//
//  DescripcionTableViewController.m
//  1sillaparamibolso
//
...
@interface DescripcionTableViewController ()
{
    NSArray *Fotos;
}
...
@implementation DescripcionTableViewController
@synthesize recipeLabel,recipeLabel2,recipeLabel3,recipeLabel4;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TableViewCell *Celll = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    
    if (!Celll) {
        Celll = [[TableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
        
    }
    
    Celll.image.image = [Fotos objectAtIndex:indexPath.row];
